...
An umbrella index of general coding-practice repos, grouped by language. Each is a standalone repo, linked here as a submodule.
...
```bash
git clone --recurse-submodules https://github.com/venkata-vazrala/coding-practice.git
